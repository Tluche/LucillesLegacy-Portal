    ...
    <div className="min-h-screen bg-white lg:grid lg:grid-cols-[18rem_1fr]">
      ...
      >
        ...
        <button
          ...
          className="mt-6 flex w-full items-center gap-3 rounded-xl px-3 py-3 text-left font-bold text-legacy-muted hover:bg-legacy-lavender hover:text-legacy-plum"
        >
          <LogOut size={19} />
          Logout
        </button>
